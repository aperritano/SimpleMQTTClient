...
public class SimpleMQTTClient: NSObject, MQTTSessionDelegate {
    ...
    @nonobjc public func subAckReceived(_ session: MQTTSession, msgID: UInt16, grantedQoss: [AnyObject]) {
        if let channel = subscribedChannelMessageIds[Int(msgID)] {
            subscribedChannels[channel] = true
        }
    }
    
    @nonobjc public func unsubAckReceived(_ session: MQTTSession, msgID: UInt16, grantedQoss: [AnyObject]) {
